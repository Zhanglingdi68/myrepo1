...
setwd("C:/Repositories/bios6624-zhanglingdi68/Project1/code/")
source('Macro.R')

#Reading data
data<-read.csv("C:/Repositories/bios6624-zhanglingdi68/Project1/DataRaw/hiv_6624_final.csv",header=T,na.strings = "NA")
...
write_csv(data_wide, "C:/Repositories/bios6624-zhanglingdi68/Project1/DataProcessed/DataClean.csv")

write_csv(data_wide, "C:/Repositories/bios6624-zhanglingdi68/Project1/DataProcessed/DataClean.R")